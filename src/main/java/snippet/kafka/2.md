...
Zero-copy 零拷技术减少拷贝次数 https://baijiahao.baidu.com/s?id=1719714471641825883&wfr=spider&for=pc
...
20、Kafka中的事务是怎么实现的？
参考：Kafka科普系列 | Kafka中的事务是什么样子的？

21、Kafka中有那些地方需要选举？这些地方的选举策略又有哪些？
kafka leader选举机制原理：https://zhuanlan.zhihu.com/p/331907620
